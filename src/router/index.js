...
/*小说工具*/
const BookSearch = _import('book/search');
const BookManage = _import('book/manage');
...
const constantRouterMap = [
    ...
    //小说工具
    {
        ...
        name: '小说工具',
        children: [
            {path: 'search', component: BookSearch, name: '小说搜索'},
            {path: 'manage', component: BookManage, name: '小说管理'}
        ]
    },
    {
        path: '/example',
