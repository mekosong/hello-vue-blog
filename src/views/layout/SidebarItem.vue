    ...
    <div>
        ...
        <template v-if="routes">
           ...
           <!--  <router-link  to="/index/readme"  v-if="routes['/index/readme']" >
            ...
            <!--小说搜索-->
            <el-submenu index="小说工具" >
                <template slot="title">
                    <i class="fa fa-book fa-fw" aria-hidden="true"></i> 小说工具
                </template>
<!--v-if="routes['/book/search']"-->
                <router-link  class="menu-indent" to="/book/search" >
                    <el-menu-item index="/book/search">
                        小说搜索
                    </el-menu-item>
                </router-link>
                <!--v-if="routes['/book/manage']"-->
                <router-link  class="menu-indent" to="/book/manage" >
